export const PARKS = [
  ...
  },
  {
    ...
    brand: "universal",
    color: "#7C3AED",
    entityId: "12dbb85b-265f-44e6-bccf-f1faa17211fc",
    lat: 28.4161,
    lng: -81.4674,
  },
  // Universal Hollywood
  ...
  // Universal Japan
  {
    ...
    resort: "Universal Japan",
    brand: "universal",
    color: "#2563EB",
    entityId: "47f61fac-7586-41ac-ae80-61c9257cf33e",
    lat: 34.6654,
    lng: 135.4323,
    isMainPark: true,
  },
  // Universal Singapore
  {
    ...
    resort: "Universal Singapore",
    brand: "universal",
    color: "#CA8A04",
    entityId: "f95d7f76-2024-4510-b799-26e122d0e448",
    lat: 1.254,
    lng: 103.8238,
    isMainPark: true,
  },
  // Universal Beijing
  {
    ...
    brand: "universal",
    color: "#059669",
    entityId: "68e1d8f0-ed42-4351-af25-160421e37ce0",
    lat: 39.9954,
    lng: 116.6694,
    isMainPark: true,
  },
...
> = {
  ...
  "Disneyland Paris": { lat: 48.8674, lng: 2.7836, timezone: "Europe/Paris" },
  ...
  "Universal Japan": { lat: 34.6654, lng: 135.4323, timezone: "Asia/Tokyo" },
  "Universal Singapore": {
    lat: 1.254,
    lng: 103.8238,
